...
- **Expected surface:** Two report presentation helpers; focused renderer tests; governed change package; acceptance harness assertion correction.
...
- **Direct proof:** Sparse source ranks render as 1..N in accepted order; duplicated verdict appears once; distinct verdict still appears once; next-step/limitations remain; exact authenticated browser and page-selected PDFs pass.
