...
function commonRules() {
  return [
    ...
    "6. Do not convert a content-detection gap into an AI-search limitation unless WriterInput directly assesses and supports that AI-search condition. When direct AI-search evidence is absent or partial, frame direct-answer content as an opportunity rather than an established current limitation.",
    ...
    "8c. Never state an unmeasured commercial or business outcome as an established fact. Do not say that an evidence condition will, should, cause, drive, result in, increase, decrease, reduce, improve, hurt, damage, cost, or lose revenue, sales, leads, enquiries, conversions, traffic, rankings, engagement, abandonment, bounce rate, customers, or pipeline. When discussing possible business significance, use evidence-bounded language such as may, could, risk, potential, opportunity, or suggests, and identify the observable condition rather than claiming the outcome.",
