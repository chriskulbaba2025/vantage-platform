...
function commonRules() {
  return [
    ...
    "11c. When conversionInfluence.orderedFindingIds is empty, rootCause.narrative.text MUST use neutral evidence-bounded wording equivalent to 'No material root cause was established from the assessed evidence; causal impact was not measured.' and conversion.constraints.text MUST use neutral evidence-bounded wording equivalent to 'No material conversion constraint was established from the assessed evidence; conversion impact was not measured.' Keep both fields present with their exact governed evidence references. Do not use causal certainty, commercial outcome claims, or language such as will/should/cause/result in/increase/reduce conversions, enquiries, leads, sales, revenue, or pipeline.",
