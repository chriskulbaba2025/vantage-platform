...
function commonRules() {
  return [
    ...
    "8f. For performance and UX evidence, name the measured technical condition (for example, slow mobile largest contentful paint) in executiveConclusion.headline, rootCause.headline, conversion.priority, and similar decision labels. Visitor friction, buyer hesitation, engagement effects, abandonment, and commercial effects are implications only: describe them with may, might, could, possible, potential, or risk. Never present mobile friction as an established observed condition or as a confirmed condition to remove when the evidence directly measures only a lab/performance metric.",
