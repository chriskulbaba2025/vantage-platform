...
function commonRules() {
  return [
    ...
    "4a. Each finding.businessImpactContext is the only Writer authority for business significance: basis is OBSERVED or INFERRED, outcomeStatus is governed evidence status, and evidenceRefs identify the supporting scope. The raw source businessImpact is provenance/context, not proof of a measured outcome. For INFERRED or non-AVAILABLE outcomeStatus, preserve the observed condition and keep downstream significance bounded. For OBSERVED with AVAILABLE direct outcome evidence, stay within the exact measured scope; do not extrapolate to a broader commercial result.",
