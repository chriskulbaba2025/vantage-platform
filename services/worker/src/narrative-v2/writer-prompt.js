...
function commonRules() {
  return [
    ...
    "4a. Each finding.businessImpactContext is the only Writer authority for business significance. In this release commercialOutcomeAuthority is PAUSED: basis is INFERRED for downstream commercial significance, while conditionBasis may preserve an OBSERVED technical or condition measurement. The raw source businessImpact is provenance only and must not be copied as authority. Preserve the observed condition and use only the bounded significance supplied by the context; never turn an observed condition, AVAILABLE proxy, or evidence reference into an observed conversion, enquiry, lead, sales, revenue, abandonment, or other downstream commercial outcome.",
    ...
    "8c. Partial or directional competitor evidence does not establish a present differentiator, advantage, disadvantage, market position, or superiority. In competitors.*, distinguish an observed comparison from a differentiator to develop or protect; use opportunity language unless the cited competitor evidence directly establishes the differentiator.",
    "8d. A visible form, CTA, enquiry route, or conversion-path condition is not a confirmed conversion, lead, enquiry, or customer outcome. Describe the assessed path as an observed route or opportunity and keep downstream commercial effects bounded; never call an action 'confirmed' unless WriterInput directly records that completed outcome.",
    "8e. Never state an unmeasured commercial or business outcome as an established fact. Before returning JSON, scan EVERY atom and inspect EVERY sentence in EVERY atom (including executiveConclusion, rootCause.businessConsequences, conversion.businessMeaning, actionPlan, and executiveDecision) independently. If one sentence contains a business-outcome noun paired with causal/certainty language, the whole output is invalid even when another sentence in the same atom is bounded and even when the cited evidence is real. Do not say that an evidence condition will, should, cause, drive, result in, increase, decrease, reduce, improve, hurt, damage, cost, or lose revenue, sales, leads, enquiries, conversions, traffic, rankings, engagement, abandonment, bounce rate, customers, or pipeline. Rewrite that sentence before returning JSON so it names only the observed condition and bounded significance: use may, might, could, risk, potential, opportunity, or suggests, or explicitly state that the outcome was not measured. For example, replace 'the missing proof will reduce conversions' with 'the available evidence shows a proof condition that may create hesitation; conversion impact was not measured.' Do not rely on a citation to make an unmeasured outcome causal. This rule applies to pass 1 and every revision pass.",
    "8f. For performance and UX evidence, name the measured technical condition (for example, slow mobile largest contentful paint) in executiveConclusion.headline, rootCause.headline, conversion.priority, actionPlan.title, actionPlan.whyNow, actionPlan.expectedBusinessEffect, and every similar headline, title, label, summary, or body field. When the evidence directly measures only a lab/performance metric, the output MUST NOT upgrade that metric into an established user condition anywhere: do not write assessed/established/confirmed mobile friction, performance friction condition, visitor friction, usability, or a condition to remove. Visitor friction, buyer hesitation, engagement effects, abandonment, and commercial effects are implications only and require may, might, could, possible, potential, or risk. Use wording such as 'slow mobile LCP was measured and may create friction'; do not use wording such as 'mobile friction was assessed' or 'performance friction was established'. A clear, visible, or interactable route is an observed route only: it does not establish usability, effectiveness, a usable foundation, completed enquiries, or conversion performance. In every headline, label, summary, and body field, describe that evidence only as a clear/available/observed route or a foundation for further optimization unless direct evidence measures usability or outcomes.",
    ...
    "11b. When conversionInfluence.orderedFindingIds is empty, strengths and actionPlan MUST both be empty arrays. Do not manufacture a positive strength, corrective action, root cause, or recommendation; use the governed evidence-limit references to explain what was and was not assessed.",
    "11c. When conversionInfluence.orderedFindingIds is empty, rootCause.narrative.text MUST use neutral evidence-bounded wording equivalent to 'No material root cause was established from the assessed evidence; causal impact was not measured.' and conversion.constraints.text MUST use neutral evidence-bounded wording equivalent to 'No material constraint on the assessed next-step route was established from the available evidence; downstream impact was not measured.' Use this validator-safe neutral wording exactly when possible. Keep both fields present with their exact governed evidence references. Do not use causal certainty, commercial outcome claims, or language such as will/should/cause/result in/increase/reduce conversions, enquiries, leads, sales, revenue, or pipeline.",
    "11a. For every P1-related conclusion, WriterInput.deterministicAnalysis.crossReportInterpretation is the sole semantic authority. Do not independently relabel offer clarity, CTA clarity, conversion-path clarity, trust proof, mobile usability, or indexability. Where CTA clarity and conversion-path clarity differ, explain that CTA clarity assesses the observed invitation, while conversion-path clarity assesses the observed route from that invitation toward the next step. Path clarity does not establish that visitors completed the action or converted.",
