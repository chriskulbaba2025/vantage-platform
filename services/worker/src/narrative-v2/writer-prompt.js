...
function commonRules() {
  return [
    ...
    "11c. When conversionInfluence.orderedFindingIds is empty, rootCause.narrative and conversion.constraints MUST remain neutral and evidence-bounded. State that no material root cause or conversion constraint was established from the assessed evidence, or that the condition was not assessed sufficiently to establish one. Do not use causal certainty, commercial outcome claims, or language such as will/should/cause/result in/increase/reduce conversions, enquiries, leads, sales, revenue, or pipeline.",
