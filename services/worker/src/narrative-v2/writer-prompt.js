...
function commonRules() {
  return [
    ...
    "8c. Never state an unmeasured commercial or business outcome as an established fact. Before returning JSON, scan EVERY atom (including executiveConclusion, rootCause.businessConsequences, conversion.businessMeaning, actionPlan, and executiveDecision) for a business-outcome noun paired with causal/certainty language. Do not say that an evidence condition will, should, cause, drive, result in, increase, decrease, reduce, improve, hurt, damage, cost, or lose revenue, sales, leads, enquiries, conversions, traffic, rankings, engagement, abandonment, bounce rate, customers, or pipeline. If such a sentence is drafted, rewrite it to name only the observed condition and its bounded significance: use may, might, could, risk, potential, opportunity, or suggests, or state that the outcome was not measured. For example, replace 'the missing proof will reduce conversions' with 'the available evidence shows a proof condition that may create hesitation; conversion impact was not measured.' Do not rely on a citation to make an unmeasured outcome causal.",
