...
// ---------------------------------------------------------------------------
// T9-RR-01: pending â†’ approved records previousValue "pending"
// ---------------------------------------------------------------------------

test("T9-RR-01: pending â†’ approved transition records previousValue pending", () => {
...
// ---------------------------------------------------------------------------
// T9-RR-02: approved â†’ rejected records previousValue "approved"
// ---------------------------------------------------------------------------

test("T9-RR-02: approved â†’ rejected transition records previousValue approved", () => {
...
// ---------------------------------------------------------------------------
// T9-RR-03: rejected â†’ approved records previousValue "rejected"
// ---------------------------------------------------------------------------

test("T9-RR-03: rejected â†’ approved transition records previousValue rejected", () => {
...
// ---------------------------------------------------------------------------
// T9-RR-05: full re-review workflow (approved â†’ rejected)
// ---------------------------------------------------------------------------
...
test("T9-RR-05: re-review changes approved candidate to rejected, prior overrides remain", async () => {
  ...
  for (const ov of newOverrides) {
    assert.equal(ov.previousValue, "approved", "New override should record approved â†’ rejected");
