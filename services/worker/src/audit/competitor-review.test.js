...
const SUPPLIED_COMPETITORS = [
  {
    ...
    evidence: {
      ...
      audience: "Business leaders seeking consulting and coaching services",
      commercialIntent: "Consulting and coaching services are offered for purchase",
      pageCount: 15,
  ...
  },
  {
    ...
    evidence: {
      services: ["Web Design"],
      geographicContext: "Toronto, Ontario, Canada",
      audience: "Businesses seeking web design services",
      commercialIntent: "Web design services are offered for purchase",
      pageCount: 8,
