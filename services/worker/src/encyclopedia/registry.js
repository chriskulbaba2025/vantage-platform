...
function buildProblem([id, name, classification, journeyStage]) {
  ...
  return {
    ...
    firstDiagnosticChecks: [`Confirm the recorded ${name.toLowerCase()} condition and its assessed scope.`, "Check a plausible alternative explanation without assuming cause.", "Retest the affected page, template, device or flow."],
    ...
    verificationMethod: `Retest the recorded ${name.toLowerCase()} condition at the governed scope and preserve outcome measurement as a separate question.`,
