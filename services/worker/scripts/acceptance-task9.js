...
try { const r = qualifyCandidate({ candidateUrl: "https://c.example/s", domain: "c.example", topic: "consulting", observedServiceContext: "Consulting", serviceEvidenceSource: "observed-page-service", pageType: "service", geographicContext: "Toronto", audienceContext: "Toronto consulting buyers", commercialContext: "Consulting services offered", discoverySource: "serp" }, { location: "Toronto", services: ["Consulting"] }); scenarios.push({ name: "Qualification gate", ok: r.passed }); if (!r.passed) pass = false; } catch (e) { console.log("FAIL: qual gate — " + e.message); pass = false; }
...
try {
  ...
  const C = [{ url:"https://c.example/s", status:SOURCE_STATUS.AVAILABLE, evidence:{ services:["Consulting"], geographicContext:"Toronto", audience:"Toronto consulting buyers", commercialIntent:"Consulting services offered", pageCount:10, trust:{testimonials:true,credentials:true,caseStudies:false,faq:true,pricing:true,policies:true,contact:true}, schemaTypes:["Service"], ctas:[{text:"B",url:"https://c.example/b",kind:"link"}], forms:[], domain:"c.example", socialLinks:[], topicKeywords:[], pages:[{title:"C",headings:{h1:["Consulting"],h2:[],h3:[],h4:[]},responseHeaders:{}}], platform:"WP" } }];
